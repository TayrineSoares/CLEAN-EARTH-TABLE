...
const Cart = ({ cart, removeOneFromCart, addOneFromCart, removeAll }) => {
  ...
  useEffect(() => {
    fetch('https://clean-earth-table-q1c5u5vhq-earth-table.vercel.app/api/cart')
      .then(res => {
        if(!res.ok) {
  ...
  const handleCheckout = async () => {
    ...
    const response = await fetch('https://clean-earth-table-q1c5u5vhq-earth-table.vercel.app/api/create-checkout-session', {
      method: 'POST',
      headers: {
